    ...
    <div className="bg-[#B39DDB]/10  rounded-2xl shadow-sm border border-gray-200 p-6">
      ...
      <div className="flex items-start gap-4 mb-6">
        ...
        <div className="flex-1">
          ...
          <div className="flex items-center gap-1 mt-1">
            <Star size={16} fill="#B39DDB" color="#B39DDB" />
            <span className="text-sm font-medium text-gray-800">{peer.rating}</span>
          </div>
        </div>
      </div>
      ...
      <div className="flex gap-4 mb-6">
        <div className="flex-1 bg-white rounded-2xl border border-[#B39DDB]/30 p-2 text-center">
          <p className="text-xs text-gray-800 mb-1">Total Sessions</p>
          <p className="text-2xl font-semibold text-gray-800">{peer.totalSessions}</p>
        </div>
        <div className="flex-1 bg-white rounded-2xl border border-[#B39DDB]/30 p-2 text-center">
          <p className="text-xs text-gray-800 mb-1">Upcoming</p>
          <p className="text-2xl font-semibold text-gray-800">{peer.upcomingSessions}</p>
        </div>
      </div>

      {/* Available This Week */}
      <div className=' bg-white rounded-2xl border border-[#B39DDB]/30 p-2'>
        <h4 className="text-sm font-medium text-gray-800 mb-3">Available This Week</h4>
